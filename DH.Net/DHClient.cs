...
namespace DH.Net
{
    ...
    public class DHClient
    {
        ...
        public async Task<int?> GivePointsAsync(ulong target_id, ulong guild_id, int amount)
        {
            ...
            if (res.IsSuccessStatusCode) return (int)JObject.Parse(data).SelectToken("points");
            else
            {
        ...
        public async Task<int?> GetBalanceAsync(ulong target_id, ulong guild_id)
        {
        ...
        /// <param name="amount">The amount of points to give to the user</param>
        /// <returns>The new balance of the user on success, or null if unsuccessful</returns>
        public async Task<int?> RemovePointsAsync(ulong target_id, ulong guild_id, int amount)
        {
        ...
        public async Task<bool> GiveItemAsync(ulong target_id, ulong guild_id, int item_id)
        {
        ...
        public async Task<int?> GiveExpAsync(ulong target_id, ulong guild_id, int amount)
        {
            ...
            var data = await res.Content.ReadAsStringAsync().ConfigureAwait(false);
            if (res.IsSuccessStatusCode) return (int)JObject.Parse(data).SelectToken("exp");
            else
            {
                this.DHClientErrored?.Invoke(JObject.Parse(data).SelectToken("message").ToString());
                return null;
        ...
        /// <param name="amount">The amount of exp to give to the user</param>
        /// <returns>The new exp amount of the user on success, or null if unsuccessful</returns>
        public async Task<int?> RemoveExpAsync(ulong target_id, ulong guild_id, int amount)
        {
        ...
        [Obsolete("This endpoint seems non-functional and only returns an error response")]
